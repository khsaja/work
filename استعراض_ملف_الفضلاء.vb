...
Public Class استعراض_ملف_الفضلاء
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        Me.Hide()
        Dim form1 As New تقرير_ملف_الفضلاء()
        form1.Show()
    End Sub

    Private Sub استعراض_ملف_الفضلاء_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        dt.Columns.Add("القيمة")    ' العمود الثالث للقيم الفعلية
