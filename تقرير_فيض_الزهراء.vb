...
Public Class تقرير_فيض_الزهراء
    ...
    Private Sub تقرير_فيض_الزهراء_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        ...
        If CheckBox1.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM voter_faedALZAHRAA) + (SELECT COUNT(*) FROM AXIS_faedalZAHRAA) AS [عدد الناخبين]")
        End If

        If CheckBox2.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA) AS [عدد المحور]")

        End If

        If CheckBox3.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM voter_faedALZAHRAA) AS [عدد الكسب]")

        End If

        'الفني
        If CheckBox4.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'ملف الشباب')  AS [محاور ملف الشباب]")
        End If

        If CheckBox7.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'ملف الرياضة')  AS [محاور ملف الرياضة]")
        End If

        If CheckBox6.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'ملف العشائر')  AS [محاور ملف العشائر]")
        End If

        If CheckBox5.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'الملف النسوي')  AS [محاور ملف النسوي]")
        End If

        If CheckBox9.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'الملف المهني')  AS [محاور ملف المهني]")
        End If


        'التنفيذي
        If CheckBox10.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'ملف المراقبين')  AS [محاور ملف المراقبين]")
        End If

        If CheckBox11.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type = 'ملف المرشدين')  AS [محاور ملف المرشدين]")
        End If


        'التنفيذي
        If CheckBox13.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axlecardstatus = 'محدثة')  AS [عدد البطائق  محدثة]")
        End If

        If CheckBox12.Checked Then
            SelectedFields.Add("(SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axlecardstatus = 'غير محدثة')  AS [عدد البطائق الغير محدثة]")
        End If
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        'احتياط
        ...
        Me.Hide()
        Dim form2 As New استعراض_فيض_الزهراء(finalQuery)
        form2.Show()
        ''
    End Sub
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Dim finalQuery As String = "SELECT " & String.Join(", ", SelectedFields) &
                                   " FROM voter_faedALZAHRAA v " &
                                   " INNER JOIN AXIS_faedalZAHRAA p ON v.ID_AXIS_faedZAHRAA = p.ID"
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        If usingJoin Then
            baseQuery = "FROM AXIS_faedalZAHRAA af LEFT JOIN voter_faedALZAHRAA vf ON af.ID = vf.ID_AXIS_faedZAHRAA "
        Else
            baseQuery = "FROM AXIS_faedalZAHRAA af "
        End If
        ...
        Try
            ...
            Using conn As New SqlConnection(connString)
                Using cmd As New SqlCommand(finalQuery.ToString(), conn)
                    ...
                    Else
                        Dim form2 As New استعراض_فيض_الزهراء(finalQuery.ToString())
                        form2.Show()
    ...
    Private Sub TextBox14_TextChanged(sender As Object, e As EventArgs) Handles TextBox14.TextChanged
        ...
        Dim searchQuery As String = "SELECT voter_name FROM voter_faedALZAHRAA WHERE voter_name LIKE @name + '%'"
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        Dim query As String = "SELECT " & String.Join(", ", SelectedFields) &
                      " FROM voter_faedALZAHRAA vf " &
                      " INNER JOIN AXIS_faedalZAHRAA af ON af.ID = vf.ID_AXIS_faedZAHRAA " &
        ...
        Try
            Using conn As New SqlConnection(connString),
                ...
                Using reader As SqlDataReader = cmd.ExecuteReader()
                    ...
                    Else
                        ' فتح الفورمة الثانية وعرض البيانات
                        Dim form2 As New استعراض_فيض_الزهراء(query)
                        form2.Show()
