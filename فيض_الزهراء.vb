...
Public Class فيض_الزهراء
    ...
    Private Sub LoadData()
        Try
            ...
            Dim query As String = "SELECT ID_AXIS_faedZAHRAA,voter_name, degree_kinship, voter_phone, voter_address, votercardnumber, votercardstatus, Filter_files, Nominate_observer, Nominate_mentor, Polling_center_number FROM voter_faedALZAHRAA"
    ...
    Private Sub DeleteRecord()
        Try
            Using sqlcon As New SqlConnection("Server=DESKTOP-08SGMQ2\SQLEXPRESS;Database=white_hand;Integrated Security=True")
                sqlcon.Open()
                Dim query As String = "DELETE FROM voter_faedALZAHRAA WHERE voter_name = @voter_name"
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        Try
            ...
            Dim cmd As New SqlCommand("SELECT * FROM voter_faedALZAHRAA WHERE voter_name= @voter_name", sqlcon)
            cmd.Parameters.AddWithValue("@voter_name", TextBox19.Text)
    ...
    Private Sub TextBox14_TextChanged(sender As Object, e As EventArgs) Handles TextBox14.TextChanged
        ...
        Try
            ...
            Dim cmd As New SqlCommand("SELECT NAME + ' ' + FATHER + ' ' + GRANDFATHER + ' ' + great_father + ' ' + Title AS FullName FROM AXIS_faedalZAHRAA WHERE NAME LIKE @Search OR FATHER LIKE @Search OR GRANDFATHER LIKE @Search OR great_father LIKE @Search OR Title LIKE @Search", sqlcon)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Try
            ...
            ' استعلام لجلب كافة تفاصيل الشخص بناءً على الاسم المدخل في TextBox14
            Dim cmd As New SqlCommand("SELECT * FROM AXIS_faedalZAHRAA WHERE NAME + ' ' + FATHER + ' ' + GRANDFATHER + ' ' + great_father + ' ' + Title = @FullName", sqlcon)
            ...
            If pivotFullName1 <> "" Then
                Try
                    ...
                    Dim query As String = "SELECT COUNT(*) FROM voter_faedALZAHRAA vf " & _
                                          "INNER JOIN AXIS_faedalZAHRAA af ON af.ID = vf.ID_AXIS_faedZAHRAA " & _
    ...
    Public Function GetAxisIDByFullName(fullName As String) As Integer
        ...
        Dim query As String = "SELECT ID FROM AXIS_faedalZAHRAA WHERE (NAME + ' ' + FATHER + ' ' + GRANDFATHER + ' ' + great_father + ' ' + Title) = @FullName"
    ...
    Public Function GetVotersByAxisID(axisID As Integer) As DataTable
        ...
        Dim query As String = "SELECT ID, voter_name, degree_kinship, voter_phone, voter_address, votercardnumber, votercardstatus, Filter_files, Nominate_observer, Nominate_mentor, Polling_center_number FROM voter_faedALZAHRAA WHERE voter_faedALZAHRAA.ID_AXIS_faedZAHRAA = @ID"
        Dim dt As New DataTable()
    ...
    Private Sub DeleteRecord1()
        Try
            Using sqlcon As New SqlConnection("Server=DESKTOP-08SGMQ2\SQLEXPRESS;Database=white_hand;Integrated Security=True")
                sqlcon.Open()
                Dim query As String = "DELETE FROM AXIS_faedalZAHRAA WHERE ID = @ID"
                Using cmd As New SqlCommand(query, sqlcon)
                    cmd.Parameters.AddWithValue("@ID", TextBox68.Text)
                    cmd.ExecuteNonQuery()
                End Using
    ...
    Private Sub PictureBox5_Click(sender As Object, e As EventArgs) Handles PictureBox5.Click
        ...
        If PictureBox5.Image IsNot Nothing AndAlso TextBox43.Text <> "لا يوجد" Then
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = PictureBox5.Image
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.BorderStyle = BorderStyle.FixedSingle ' ✅ إضافة إطار للصورة الكبيرة
            واجهة_عرض__صور_فيض_الزهراء.ShowDialog() ' ✅ جعلها تظهر كنافذة مستقلة وتغلق بعد المشاهدة
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = Nothing ' ✅ مسح الصورة عند الإغلاق
        End If
    ...
    Private Sub PictureBox6_Click(sender As Object, e As EventArgs) Handles PictureBox6.Click
        ...
        If PictureBox6.Image IsNot Nothing AndAlso TextBox21.Text <> "لا يوجد" Then
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = PictureBox6.Image
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.BorderStyle = BorderStyle.FixedSingle ' ✅ إضافة إطار للصورة الكبيرة
            واجهة_عرض__صور_فيض_الزهراء.ShowDialog() ' ✅ جعلها تظهر كنافذة مستقلة وتغلق بعد المشاهدة
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = Nothing ' ✅ مسح الصورة عند الإغلاق
        End If
    ...
    Private Sub PictureBox7_Click(sender As Object, e As EventArgs) Handles PictureBox7.Click
        ...
        If PictureBox7.Image IsNot Nothing AndAlso TextBox39.Text <> "لا يوجد" Then
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = PictureBox7.Image
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.BorderStyle = BorderStyle.FixedSingle ' ✅ إضافة إطار للصورة الكبيرة
            واجهة_عرض__صور_فيض_الزهراء.ShowDialog() ' ✅ جعلها تظهر كنافذة مستقلة وتغلق بعد المشاهدة
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = Nothing ' ✅ مسح الصورة عند الإغلاق
        End If
    ...
    Private Sub PictureBox8_Click(sender As Object, e As EventArgs) Handles PictureBox8.Click
        ...
        If PictureBox8.Image IsNot Nothing AndAlso TextBox67.Text <> "لا يوجد" Then
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = PictureBox8.Image
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.BorderStyle = BorderStyle.FixedSingle ' ✅ إضافة إطار للصورة الكبيرة
            واجهة_عرض__صور_فيض_الزهراء.ShowDialog() ' ✅ جعلها تظهر كنافذة مستقلة وتغلق بعد المشاهدة
            واجهة_عرض__صور_فيض_الزهراء.PictureBoxshow.Image = Nothing ' ✅ مسح الصورة عند الإغلاق
        End If
    ...
    Private Sub تحديث_جميع_الإحصائيات()
        Try
            ...
            Dim cmd As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE NAME IS NOT NULL", sqlcon)
            ' الحصول على العدد
            ...
            Dim cmd1 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE voter_name IS NOT NULL", sqlcon)
            ' الحصول على العدد
            Dim count1 As Integer = Convert.ToInt32(cmd1.ExecuteScalar())
            ' تحديث الـ TextBox بالعدد
            ...
            Dim cmd2 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE NAME IS NOT NULL", sqlcon)
            Dim count2 As Integer = Convert.ToInt32(cmd2.ExecuteScalar())

            ' استعلام لحساب عدد السجلات في الحقل الثاني (مثلاً: الحقل الثاني)
            Dim cmd3 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE voter_name IS NOT NULL", sqlcon)
            ...
            '''''''''''''''''''''''''''''''''''''''
            ' استعلام لحساب عدد السجلات في حقل الكسب
            Dim cmd4 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE voter_name IS NOT NULL", sqlcon)
            ' الحصول على العدد
    ...
    Private Sub تحديث_إحصائيات_الكلمات()
        Try
            ...
            Dim cmd As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE votercardstatus LIKE @Keyword", sqlcon)
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd1 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE votercardstatus LIKE @Keyword1", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd2 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axlecardstatus LIKE @Keyword2", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            cmd2.Parameters.AddWithValue("@Keyword2", "%" & "محدثة" & "%")
            ' تنفيذ الاستعلام وحساب العدد
            Dim count2 As Integer = Convert.ToInt32(cmd2.ExecuteScalar())

            Dim cmd12 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE votercardstatus LIKE @Keyword12", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd3 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axlecardstatus LIKE @Keyword3", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd13 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE votercardstatus LIKE @Keyword13", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd4 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword4", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd14 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword14", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd5 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword5", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd15 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword15", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd6 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword6", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd16 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword16", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd7 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword7", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            cmd7.Parameters.AddWithValue("@Keyword7", "%" & "ملف العشائر" & "%")
            ' تنفيذ الاستعلام وحساب العدد
            Dim count7 As Integer = Convert.ToInt32(cmd7.ExecuteScalar())

            Dim cmd17 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword17", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd8 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword8", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            cmd8.Parameters.AddWithValue("@Keyword8", "%" & "الملف المهني" & "%")
            ' تنفيذ الاستعلام وحساب العدد
            Dim count8 As Integer = Convert.ToInt32(cmd8.ExecuteScalar())

            Dim cmd18 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword18", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd9 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword9", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            cmd9.Parameters.AddWithValue("@Keyword9", "%" & "ملف المراقبين" & "%")
            ' تنفيذ الاستعلام وحساب العدد
            Dim count9 As Integer = Convert.ToInt32(cmd9.ExecuteScalar())

            Dim cmd19 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword19", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            ...
            ' استعلام SQL لحساب عدد تكرار كلمة "الشباب" في الحقل المعين
            Dim cmd10 As New SqlCommand("SELECT COUNT(*) FROM AXIS_faedalZAHRAA WHERE axle_type LIKE @Keyword10", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
            cmd10.Parameters.AddWithValue("@Keyword10", "%" & "ملف المرشدين" & "%")
            ' تنفيذ الاستعلام وحساب العدد
            Dim count10 As Integer = Convert.ToInt32(cmd10.ExecuteScalar())

            Dim cmd20 As New SqlCommand("SELECT COUNT(*) FROM voter_faedALZAHRAA WHERE Filter_files LIKE @Keyword20", sqlcon)
            ' إضافة الكلمة "الشباب" للبحث في الاستعلام
